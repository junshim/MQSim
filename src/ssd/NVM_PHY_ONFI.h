...
{
	enum class ChipStatus { IDLE, CMD_IN, CMD_DATA_IN, DATA_OUT, READING, WRITING, ERASING, WAIT_FOR_DATA_OUT, WAIT_FOR_COPYBACK_CMD, ERASING_SUBBLOCK, WAIT_FOR_GC_READ, PRIMARY_ERS };
	...
	public:
		...
		virtual ChipStatus GetChipSubStatus(NVM::FlashMemory::Flash_Chip* chip) = 0;
#endif
